...
class dtm_t : public htif_t
{
 public:
  ...
  uint64_t dtm_read_csr(unsigned which);
  uint64_t dtm_write_csr(unsigned which, uint64_t data);
  uint64_t dtm_clear_csr(unsigned which, uint64_t data);
  uint64_t dtm_set_csr(unsigned which, uint64_t data);
  void fence_i();
 ...
 private:
  ...
  uint64_t dtm_modify_csr(unsigned which, uint64_t data, uint32_t type);
