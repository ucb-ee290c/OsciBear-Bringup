...
void tsi_t::reset()
{
  ...
  // Make the clocks faster
  write_scr(SCR_BASE + SCR_UNCORE_CLK_DIVISOR, 1);
  write_scr(SCR_BASE + SCR_BH_CLK_DIVISOR, 1);
  write_scr(SCR_BASE + SCR_RS_CLK_DIVISOR, 1);
  write_scr(SCR_BASE + SCR_LBWIF_CLK_DIVISOR, 1);

  write_scr(SCR_BASE + SCR_UNCORE_PASS_CLK_SEL, 1);
  write_scr(SCR_BASE + SCR_BH_PASS_CLK_SEL, 0);
  write_scr(SCR_BASE + SCR_RS_PASS_CLK_SEL, 0);
  write_scr(SCR_BASE + SCR_LBWIF_PASS_CLK_SEL, 0);

  // Bring BOOM and Rocket tiles out of reset
