...
// ================ NOTE: The handler is not working, need to figure out how to enable RoCC interrupt ================
...
int main(void)
{
  ...
  clint_connect_interrupt(INT_CODE_MACHINE_SOFTWARE, &plic_handler); // I believe the RoCC interupt is a machine software interrupt?
