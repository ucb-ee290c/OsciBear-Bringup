...
HD_PWD='C:/Users/DangL/school/osci-bringup/chip-hw-fa22/tsi_arty100/tsi_arty100.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chiptop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chiptop.tcl
