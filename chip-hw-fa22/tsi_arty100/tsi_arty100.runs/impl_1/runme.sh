...
HD_PWD='C:/Users/DangL/school/osci-bringup/chip-hw-fa22/tsi_arty100/tsi_arty100.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chiptop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chiptop.tcl -notrace
