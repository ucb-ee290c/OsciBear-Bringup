...
#
# Generated by Vivado on Thu Nov 03 16:14:05 -0700 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../arty_tsi.gen/sources_1/ip/clk_wiz_0_2/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../arty_tsi.gen/sources_1/ip/clk_wiz_0_2/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
