...
## Switches
set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { rstBtn }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { tl_out_rd  }]; #IO_L8N_T1_D12_14             Sch=ck_io[2]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { tl_out_data  }]; #IO_L19P_T3_A10_D26_14        Sch=ck_io[3]
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { dutReset }]; #IO_L12P_T1_MRCC_14           Sch=ck_io[13]
